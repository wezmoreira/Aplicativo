...
import com.tcccesumar.savepet.models.Passwords;
import com.tcccesumar.savepet.models.Users;
import com.tcccesumar.savepet.models.privatedetails;
...
public class Registration extends AppCompatActivity {
                    ...
                    databaseReference.child("Users").orderByChild("Username").equalTo(username).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(snapshot.exists()){
                                ...
                                mDialog.setMessage("Registrando por favor aguarde...");
                                mDialog.show();
                                            ...
                                            FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        builder.setMessage("Registrado com sucesso, por favor, verifique seu e-mail");
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(fname)) {
            ...
            Fname.setError("O nome completo é obrigatório");
        } else {
            isValidname = true;
        }
        ...
        if (TextUtils.isEmpty(pass)) {
            ...
            if (pass.length() < 6) {
                Pass.setErrorEnabled(true);
                Pass.setError("A senha é muito fraca");
            } else {
        ...
        if (TextUtils.isEmpty(mobileno)) {
            ...
            Mobileno.setError("Celular é obrigatório");
        } else {
            if (mobileno.length() < 10) {
                Mobileno.setErrorEnabled(true);
                Mobileno.setError("Celular inválido");
            } else {
        ...
        if (TextUtils.isEmpty(gender)) {
            ...
            Gender.setError("O campo não pode estar vazio");
        } else {
            isvalidgender = true;
    ...
    public void addUsers(String Discription,String FullName,String Username,String Website){
        ...
        Users user = new Users(
                ...
                FullName,
                "0",
                "https://firebasestorage.googleapis.com/v0/b/savepet-87ea0.appspot.com/o/defualt_savepet_pic.png?alt=media&token=348ea4db-aa2d-4e50-b6ad-b3a2f8e54503",
                Username,
                Website,
                useridd
        );

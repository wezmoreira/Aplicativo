package com.tcccesumar.savepet.Services.Stories;
...
import com.tcccesumar.savepet.Main.Profile.FollowersFollowing;
import com.tcccesumar.savepet.R;
import com.tcccesumar.savepet.models.Story;
import com.tcccesumar.savepet.models.Users;

public class StoryActivity extends AppCompatActivity implements StoriesProgressView.StoriesListener{

    //STORIES DESATIVADO TEMPORARIAMENTE POIS ESTA COM BUG, REMOVIDO DA VERSAO MVP
                                ...
                                reference.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            Toast.makeText(StoryActivity.this, "Excluído!", Toast.LENGTH_SHORT).show();
                                            finish();
                                        }
                                    }
                                });

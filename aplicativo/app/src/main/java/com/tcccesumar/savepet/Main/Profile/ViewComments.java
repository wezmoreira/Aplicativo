...
import com.tcccesumar.savepet.Utils.CommentListAdapter;
        ...
        mpost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!mComment.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(ViewComments.this, "Você não pode postar um comentário em branco", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
